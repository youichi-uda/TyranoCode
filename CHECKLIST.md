...
- [ ] .ks ファイルを開いた状態で `Ctrl+Shift+P` → `TyranoCode: Preview Scene`
- [ ] WebView パネルが開き、背景・キャラ配置・ダイアログのモックアップが表示される
- [ ] ファイルを編集するとプレビューがリアルタイム更新される

## テスト
- [ ] ターミナルで `cd tyranodev && npm run test:unit` → 634 tests passed
